...
// Add smooth scroll snap behavior for sections
...
console.log('%cLooking for something? Feel free to reach out!', 'font-size: 14px; color: #9ca3af;');
console.log('%c📧 abdelrahmanayman111@yahoo.com', 'font-size: 12px; color: #7c3aed;');
